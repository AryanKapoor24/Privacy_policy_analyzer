...
export default function Footer() {
  return (
    <footer className="relative bg-[#030712] border-t border-white/5 pt-16 pb-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center space-x-3 mb-6 group">
              ...
              <span className="text-2xl font-bold text-white">Lexify</span>
            </Link>
            <p className="text-gray-400 leading-relaxed mb-6 max-w-sm">
              Making legal documents understandable for everyone. Powered by AI.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Help Center', 'Contact', 'Documentation', 'Status'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors text-sm">
                    {item}
                  </a>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © 2026 Lexify. All rights reserved.
          </p>
